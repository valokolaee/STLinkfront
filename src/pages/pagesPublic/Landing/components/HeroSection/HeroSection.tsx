...
const HeroSection = () => {
  return (
    <div className='overflow-scroll w-full h-full relative cursor-default'>
      ...
      {/* describe */}
      <h3 className='text-white absolute top-40 left-60 mt-10l text-2xl'>Optimized mining performance designed for those who demand more.</h3>
